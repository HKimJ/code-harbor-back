...
public class GroupCrudController {
    ...
    @Operation(summary = "그룹원이 기존에 서비스에 가입된 인원을 그룹에 초대하는 요청", description = "초대자의 그룹명과 초대할 인원의 이메일(userId)을 전달받아 그룹에 초대")
    public ResponseEntity<GroupCrudResponseDto> acceptExistUserAsMember(@RequestParam String groupInvitee, @RequestParam String verify) {
